 ...
 * Introduction
 *
 * This assignment asked us to implement various logical operators on 
 * either one or two arrays of boolean data.
 * An example is the And operator, which is boolean from array 1 and boolean from array 2.  
 * An example of the And operator is as follows:
 ...
 * Using for loops, the program iterates through each item in single array operators, 
 * or through corresponding items 
 * in two array operators.  
 * In some methods, such as And, applying the operator to the data creates a new piece 
 * of data.
 ...
 * However, once the behaviors were learned, some of them were actually very easy 
 * to implement, such as Consistent.
 * 
 * Acknowledgments
 * 
 * The Stanford Logic website was very helpful in explaining the logical operators and their behaviors.
 * A special Thank You to Mr. Pavan Desikan for all his help with checking my code and documentation.
 * 
 * 
 */
